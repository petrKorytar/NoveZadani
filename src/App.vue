...
<script>
 ...
 export default {
  ...
  methods: {
     async fetchAllData(){
       await  axios.post('http://localhost/NoveZadani/API/index.php',{action:'fetchall'})
            .then((response)=>{
   ...
   async submitData(){
        if(this.firstName !=""&& this.lastName!="" && this.birthdate!=""&& this.superpower!=""){
            ...
            // Insert new user.
                if(this.actionButton=="Vložit"){
                  ...
                  await  axios.post('http://localhost/NoveZadani/API/index.php',{
                        action:'insert',
    ...
    fetchData(id){
        axios.post('http://localhost/NoveZadani/API/index.php',{
            action:'fetchSingle',
            id:id
